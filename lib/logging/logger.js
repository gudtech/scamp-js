...
var _new_logsink = function() {
    return new LogSink({
        topic: config.logsink_topic ? config.logsink_topic : config.tag,
        subtopic: 'service_log',
        fields: 'severity message pid',
        loggingDestination: config.loggingDestination,
    });
};
...
exports.configure = function (params) {
    ...
    config.loggingDestination = params.loggingDestination;
